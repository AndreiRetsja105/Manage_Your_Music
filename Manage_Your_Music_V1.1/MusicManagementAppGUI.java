...
public class MusicManagementAppGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainPlaylistCB = new javax.swing.JComboBox<>();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PlayList1" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PlayList2" }));

        mainPlaylistCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Main PlayList" }));
        mainPlaylistCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mainPlaylistCBActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(PRINTLayout.createSequentialGroup()
                        .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(PRINTLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(songTF, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(albumTF, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(artistTF, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(genreCB, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(mainPlaylistCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(PRINTLayout.createSequentialGroup()
            ...
            .addGroup(PRINTLayout.createSequentialGroup()
                ...
                .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PRINTLayout.createSequentialGroup()
                        ...
                        .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(artistTF, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PRINTLayout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PRINTLayout.createSequentialGroup()
                        .addComponent(mainPlaylistCB, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)))
                .addGroup(PRINTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(removeBTN)
                    .addComponent(moveBTN)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(PRINT, javax.swing.GroupLayout.PREFERRED_SIZE, 754, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    // Append the selected genre to the display
    displayTA.append(selectedGenre + "\n");
    ...
    int selectedIndex = genreCB.getSelectedIndex();
    ...
    if (selectedIndex != -1) {
        ...
        // Remove the selected genre from the combo box
        genreCB.removeItemAt(selectedIndex);
        
        // Do whatever you need to do with the selected genre
        System.out.println("Removed genre: " + selectedGenre);
    }
   ...
   // Get the search query from the text field
    ...
    String playlistText = displayTA.getText();
    
    // Split the text by newlines to get each song
    String[] songs = playlistText.split("\\n");
    
    // Iterate through the songs to find matches
    ...
    private void mainPlaylistCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mainPlaylistCBActionPerformed
        // TODO add your handling code here:
    // Get the selected playlist from the combo box
    String selectedPlaylist = (String) mainPlaylistCB.getSelectedItem();
    
    // Clear the display
    displayTA.setText("");
    
    // Check if the selected playlist matches the main playlist
    if (selectedPlaylist.equals("Main Playlist")) {
        // If it's the main playlist, display all songs from the main playlist
        for (Song song : mainPlaylist.getSongs()) {
            displayTA.append(song.toString() + "\n");
        }
    } else {
        // If it's another playlist, display all songs from that playlist
        Playlist playlist = playlists.get(selectedPlaylist);
        for (Song song : playlist.getSongs()) {
            displayTA.append(song.toString() + "\n");
        }
    }
    }//GEN-LAST:event_mainPlaylistCBActionPerformed
    ...
    private javax.swing.JComboBox<String> mainPlaylistCB;
