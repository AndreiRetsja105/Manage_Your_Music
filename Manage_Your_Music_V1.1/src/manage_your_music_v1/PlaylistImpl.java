...
public class PlaylistImpl implements Playlist {
    ...
    public PlaylistImpl(String name, List<Song> likedSongs, Map<String, List<Song>> genrePlaylists, Song lastAddedSong) {
        this.name = name;
        ...
        this.lastAddedSong = lastAddedSong;
    ...
    public void setLastAddedSong(Song lastAddedSong) {
        this.lastAddedSong = lastAddedSong;
    }
